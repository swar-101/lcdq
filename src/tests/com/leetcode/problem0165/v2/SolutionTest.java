...
public class SolutionTest {
    ...
    @Test
    void testCompareVersionNumbers_OptimizedVersion() {
        // Additional tests for the optimized String.split() version
        assertEquals(0, solution.compareVersion("0.0", "0"));
        assertEquals(1, solution.compareVersion("1.0.0.1", "1.0.0"));
        assertEquals(-1, solution.compareVersion("1.0", "1.0.0.1"));
    }
}
